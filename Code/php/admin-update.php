...
if(isset($_POST['update_product'])){
  ...
  if(empty($product_name) || empty($product_price) || empty($product_asal) || empty($product_image) || empty($product_deskripsi)){
    $message[] = 'please fill out all';
  }else{
    $update = "UPDATE products SET name='$product_name', deskripsi='$product_deskripsi', price='$product_price', asal='$product_asal', image='$product_image' WHERE id = $id";
...
<div class="container">
    ...
    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
        <h3>Update The Product</h3>
            ...
            <input type="text" placeholder="Product Desc" value="<?php echo $row['deskripsi']; ?>" name="product_deskripsi" class="box">
